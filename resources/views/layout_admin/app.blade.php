...
<!-- Mirrored from prium.github.io/phoenix/v1.13.0/apps/e-commerce/admin/add-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Nov 2023 12:10:34 GMT -->
<!-- Added by HTTrack -->
...
<head>
  ...
  <link href="{{ asset('assets/js/echarts-example.js') }}" rel="stylesheet">
  <!-- Include Bootstrap Icons from CDN -->
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.18.0/font/bootstrap-icons.css">


  <link
    href="https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;500;600;700&family=Raleway:wght@400;700&display=swap"
    rel="stylesheet">
...
<body>
 ...
 --}}
  ...
  <script src="https://prium.github.io/phoenix/v1.13.0/vendors/tinymce/tinymce.min.js"></script>
