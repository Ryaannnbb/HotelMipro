    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('kamar') ? 'active' : '' }}"
                        href="{{ route('kamar') }}" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                            <span class="nav-link-icon">
      ...
      <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
        ...
        <div class="card position-relative border-0">
            ...
            <div class="card-footer p-3 border-top">
              <div class="d-flex flex-column align-items-center"> <!-- Perubahan untuk menempatkan secara vertikal -->
                <div class="mb-3"> <!-- Menambahkan margin bottom untuk memberikan jarak antara gambar profil dan tombol log out -->
                  <a class="btn btn-phoenix-secondary d-flex flex-center" href="{{ route('logout') }}">
...
<nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop" style="display:none;">
  ...
  <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center"
    ...
    <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
              ...
              <div class="row gx-4 gy-5">
                <div class="col-12 col-sm-6 col-md-4">
                  <div class="dropdown-item-group"><span class="me-2" data-feather="file-text"
                    ...
                    class="dropdown-link" href="../../../modules/forms/basic/floating-labels.html">Floating
                    labels</a><a class="dropdown-link" href="../../../modules/forms/basic/layout.html">Layout</a><a
                    class="dropdown-link" href="../../../modules/forms/advance/advance-select.html">Advance
                    select</a><a class="dropdown-link" href="../../../modules/forms/advance/date-picker.html">Date
                ...
                <div class="col-12 col-sm-6 col-md-4">
                  <div class="dropdown-item-group"><span class="me-2" data-feather="package"
                    ...
                    class="dropdown-link" href="../../../modules/components/carousel/bootstrap.html">Bootstrap</a><a
                    class="dropdown-link" href="../../../modules/components/carousel/swiper.html">Swiper</a><a
                    ...
                    class="dropdown-link" href="../../../modules/components/list-group.html">List group</a><a
                    class="dropdown-link" href="../../../modules/components/modal.html">Modals</a><a
                    class="dropdown-link" href="../../../modules/components/navs-and-tabs/navs.html">Navs</a><a
                    class="dropdown-link" href="../../../modules/components/navs-and-tabs/navbar.html">Navbar</a><a
                    class="dropdown-link" href="../../../modules/components/navs-and-tabs/tabs.html">Tabs</a><a
                    class="dropdown-link" href="../../../modules/components/offcanvas.html">Offcanvas</a><a
                    class="dropdown-link" href="../../../modules/components/progress-bar.html">Progress bar</a><a
                    class="dropdown-link" href="../../../modules/components/placeholder.html">Placeholder</a><a
                    class="dropdown-link" href="../../../modules/components/pagination.html">Pagination</a><a
                    class="dropdown-link" href="../../../modules/components/popovers.html">Popovers</a><a
                    class="dropdown-link" href="../../../modules/components/scrollspy.html">Scrollspy</a><a
                    ...
                    class="dropdown-link" href="../../../modules/components/chat-widget.html">Chat widget</a>
                </div>
                <div class="col-12 col-sm-6 col-md-4">
                  ...
                  <div class="dropdown-item-group mt-5"><span class="me-2" data-feather="tool"
                    ...
                    class="dropdown-link" href="../../../modules/utilities/interactions.html">Interactions</a><a
                    ...
                    class="dropdown-link" href="../../../modules/utilities/typography.html">Typography</a><a
                    class="dropdown-link" href="../../../modules/utilities/vertical-align.html">Vertical align</a><a
                    class="dropdown-link" href="../../../modules/utilities/visibility.html">Visibility</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button"
          data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true"
          aria-expanded="false"><span class="uil fs-0 me-2 uil-document-layout-right"></span>Documentation</a>
        <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <div class="row gx-4 gy-5">
                  <div class="col-12 col-sm-6 col-md-4">
                    ...
                    <div class="dropdown-item-group mt-5"><span class="me-2" data-feather="bar-chart-2"
                      ...
                      charts</a><a class="dropdown-link" href="../../../modules/echarts/bar-charts.html">Bar
                  ...
                  <div class="col-12 col-sm-6 col-md-4">
                    <div class="dropdown-item-group"><span class="me-2" data-feather="columns"
                      ...
                      tables</a><a class="dropdown-link" href="../../../modules/tables/advance-tables.html">Advance
                      tables</a><a class="dropdown-link" href="../../../modules/tables/bulk-select.html">Bulk
                      Select</a>
                    <div class="dropdown-item-group mt-5"><span class="me-2" data-feather="tool"
                        style="stroke-width:2;"></span>
                      <h6 class="dropdown-item-title">Utilities</h6>
                    </div><a class="dropdown-link"
                      href="../../../modules/utilities/background.html">Background</a><a class="dropdown-link"
                      href="../../../modules/utilities/borders.html">Borders</a><a class="dropdown-link"
