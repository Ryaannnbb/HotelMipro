                        ...
                        <div class="col-md-12">
                            <form action="{{ route('pesanan.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <select class="form-select mb-3 @error('metode_pembayaran') is-invalid @enderror"
                                    ...
                                    <option value="e-wallet" data-target="ewalletInput" {{ old('metode_pembayaran') == 'e-wallet' ? 'selected' : '' }}>E-Wallet</option>
                                    <option value="bank" data-target="bankInput" {{ old('metode_pembayaran') == 'bank' ? 'selected' : '' }}>Bank</option>
                                </select>
                                ...
                                <div class="mb-3" id="bankInput" style="display: @error('tujuan_bank') block @else none @enderror;">
                                    ...
                                    @foreach ($bank as $data)
                                        <input type="text" name="keterangan_bank" value="{{ $data->keterangan }}"
                                            id="{{ $data->keterrngan }}" class="form-control" readonly disabled>
                                    @endforeach
                                </div>
                                <label class="form-label fs-0 text-1000 ps-0 text-none" for="foto">Enter your Proof of Payment</label>
