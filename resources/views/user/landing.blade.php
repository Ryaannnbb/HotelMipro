...
<!-- Mirrored from prium.github.io/phoenix/v1.13.0/pages/landing/alternate.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Nov 2023 13:00:59 GMT -->
        ...
        <div class="container-small px-lg-7 px-xxl-3">
          <div class="row g-0">
            <div class="col-6 col-md-3">
              <div class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end"><img class="img-fluid" src="../../assets/img/brand2/netflix-n.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end-md"><img class="img-fluid" src="../../assets/img/brand2/blender.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end border-end-md"><img class="img-fluid" src="../../assets/img/brand2/upwork.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-bottom border-end-lg-0"><img class="img-fluid" src="../../assets/img/brand2/facebook-f.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end border-bottom border-bottom-md-0"><img class="img-fluid" src="../../assets/img/brand2/pocket.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end-md border-bottom border-bottom-md-0"><img class="img-fluid" src="../../assets/img/brand2/mail-bluster-1.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end"><img class="img-fluid" src="../../assets/img/brand2/discord.png" alt="" /></div>
            </div>
            <div class="col-6 col-md-3">
              <div class="p-2 p-lg-5 d-flex flex-center h-100 border-1 border-dashed border-end-lg-0"><img class="img-fluid" src="../../assets/img/brand2/google-g.png" alt="" /></div>
            </div>
          </div>
      ...
      <section class="gallery"  style="background-color: #F5F7FA;">
        ...
        <div class="container-small position-relative px-lg-7 px-xxl-3">
          ...
          <div class="row g-3" id="image_gallery" data-sl-isotope='{"layoutMode":"packery"}'>
            <div class="col-6 col-md-4 px-2 isotope-item fourth"><a href="#!" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="../../assets/img/hotel1.png"><img class="rounded img-fluid w-100" src="../../assets/img/hotel1.png" alt="" /></a></div>
            <div class="col-6 col-md-4 px-2 isotope-item third"><a href="#!" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="../../assets/img/hotel2.png"><img class="rounded img-fluid w-100" src="../../assets/img/hotel2.png" alt="" /></a></div>
            <div class="col-6 col-md-4 px-2 isotope-item second"><a href="#!" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="../../assets/img/hotel3.png"><img class="rounded img-fluid w-100" src="../../assets/img/hotel3.png" alt="" /></a></div>
            <div class="col-6 col-md-4 px-2 isotope-item third"><a href="#!" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="../../assets/img/gambar4.png"><img class="rounded img-fluid w-100" src="../../assets/img/gambar4.png" alt="" /></a></div>
            <div class="col-6 col-md-4 px-2 isotope-item third"><a href="#!" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="../../assets/img/hotel6.png"><img class="rounded img-fluid w-100" src="../../assets/img/hotel6.png" alt="" /></a></div>
            <div class="col-6 col-md-4 px-2 isotope-item second"><a href="#!" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="../../assets/img/hotel5.png"><img class="rounded img-fluid w-100" src="../../assets/img/hotel5.png" alt="" /></a></div>
            <div class="col-6 col-md-4 px-2 isotope-item fourth"><a href="#!" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="../../assets/img/hotel8.png"><img class="rounded img-fluid w-100" src="../../assets/img/hotel8.png" alt="" /></a></div>
            <div class="col-6 col-md-4 px-2 isotope-item third"><a href="#!" data-bigpicture='{"gallery":"#image_gallery"}' data-bp="../../assets/img/hotel7"><img class="rounded img-fluid w-100" src="../../assets/img/hotel7.png" alt="" /></a></div>
          </div>
        </div>
      </section>
              ...
              <div class="pricing-card">
                <div class="card bg-transparent border-0">
                  <div class="card-body p-7">
                    ...
                    <h1 class="fs-5 d-flex align-items-center gap-1 mb-3">$15<span class="fs-0 fw-normal">/ month</span></h1><button class="btn btn-lg w-100 mb-7 btn-outline-primary">Buy</button>
              ...
              <div class="pricing-card">
                <div class="card bg-transparent border border-2 border-info rounded-4">
                  <div class="card-body p-7">
                    ...
                    <h1 class="fs-5 d-flex align-items-center gap-1 mb-3">$23<span class="fs-0 fw-normal">/ month</span></h1><button class="btn btn-lg w-100 mb-7 btn-primary">Buy</button>
                    <h5 class="mb-4">What’s included</h5>
                    <ul class="fa-ul ps-4 m-0 pricing">
                      <li class="d-flex align-items-center mb-3"><span class="fa-li"><span class="fas fa-check text-primary"></span></span>
                        <p class="mb-0">Timeline</p>
              ...
              <div class="pricing-card">
                <div class="card bg-transparent border-0">
                  <div class="card-body p-7">
                    ...
                    <h1 class="fs-5 d-flex align-items-center gap-1 mb-3">$40<span class="fs-0 fw-normal">/ month</span></h1><button class="btn btn-lg w-100 mb-7 btn-outline-primary">Buy</button>
                    <h5 class="mb-4">What’s included</h5>
                    <ul class="fa-ul ps-4 m-0 pricing">
                      <li class="d-flex align-items-center mb-3"><span class="fa-li"><span class="fas fa-check text-primary"></span></span>
                        <p class="mb-0">Timeline</p>
      ...
      <section class="pt-10" id="blog" style="background-color: #F5F7FA;">
        <div class="container-small px-lg-7 px-xxl-3">
          ...
          <div class="row gx-3 gy-7">
            <div class="col-lg-4">
              <div class="blog-card"><img class="w-100 rounded-3" src="../../assets/img/fasilitas.png" alt="" />

                <h2 class="mb-2" style="margin-top: 20px; font-size:20px;">Swiming Pool</h2>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="blog-card"><img class="w-100 rounded-3" src="../../assets/img/yuni1.png" alt="" />

                <h2 class="mb-2" style="margin-top: 20px; margin-bottom: 10px; font-size: 20px;">Gym</h2>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="blog-card"><img class="w-100 rounded-3" src="../../assets/img/restauran.png" alt="" />

                <h2 class="mb-2" style="margin-top: -5px; font-size:20px">Restaurant</h2>
              </div>
            </div>
          </div>
        </div><!-- end of .container-->
...
<!-- Mirrored from prium.github.io/phoenix/v1.13.0/pages/landing/alternate.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Nov 2023 13:01:16 GMT -->
</html>
